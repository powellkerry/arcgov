...
app.factory('ManageCemeteryFactory', function($http) {
    var factory = {
        ...
        loadPlots: function(cem_id, callback) {
            return $http.post('/loadPlots', {cem_id: cem_id}).success(callback).error(function() {console.warn('Failed to load cemetery plots');});
        },
        createPlot: function(plot, cem_id, callback) {
            return $http.post('/createPlot', {plot: plot, cem_id: cem_id}).success(callback).error(function() {console.warn('Failed to create plot');});
        },
        updatePlot: function(plot, cem_id, callback) {
            return $http.post('/updatePlot', {plot: plot, cem_id: cem_id}).success(callback).error(function() {console.warn('Failed to update plot');});
        },
        deletePlot: function(plot_id, callback) {
            return $http.post('/deletePlot', {plot_id: plot_id}).success(callback).error(function() {console.warn('Failed to delete plot');});
        },
        loadOwner: function(owner_id, callback) {
            return $http.post('loadOwner', {owner_id: owner_id}).success(callback).error(function() {console.warn('Failed to load owner');});
        },
        createOwner: function(owner, plot, callback) {
            return $http.post('/createOwner', {owner: owner, plot:plot}).success(callback).error(function() {console.warn('Failed to create owner');});
        },
        updateOwner: function(owner, callback) {
            return $http.post('/updateOwner', {owner:owner}).success(callback).error(function() {console.warn('Failed to update owner');});
        },
        deleteOwner: function(owner_id, callback) {
            return $http.post('/deleteOwner', {owner_id: owner_id}).success(callback).error(function() {console.warn('Failed to delete owner');});
        },
        loadOccupant: function(occupant_id, callback) {
            return $http.post('/loadOccupant', {occupant_id: occupant_id}).success(callback).error(function() {console.warn('Failed to load occupant');});
        },
        createOccupant: function(occupant, plot, callback) {
            return $http.post('/createOccupant', {occupant: occupant, plot: plot}).success(callback).error(function() {console.warn('Failed to add occupant');});
        },
        updateOccupant: function(occupant, plot, callback) {
            return $http.post('/updateOccupant', {occupant: occupant, plot: plot}).success(callback).error(function() {console.warn('Failed to update occupant');});
        },
        deleteOccupant: function(occupant_id, callback) {
            return $http.post('/deleteOccupant', {occupant_id: occupant_id}).success(callback).error(function() {console.warn('Failed to remove occupant');});
        }
    };
    return factory;
});